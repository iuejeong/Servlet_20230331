...
//			jsonAtomic.getAndUpdate(t -> t + line);		// t = 공백, t라는 공백에 json 한 줄씩 계속 넣어준다. 끝날 때까지 반복함.
//		});
//		
//		String json = jsonAtomic.get().replaceAll(" ", "");			// get을 해주면 string으로 바꿔준다. replaceAll 안에 공백의 의미는 공백을 다 제거해주겠다.
//		System.out.println(json);
		 ...
		 * POST 요청의 특징
		 * 	1. 
		 * 	<form action="요청메세지" method="post" enctype> 
